...
export default function Product() {
    ...
    const [data, setData] = useState<objectVapesTypeSingle>()
    ...
    return <section className="w-full h-full ">
        {
            ...
            <div className="py-20 lg:py-10 px-6 lg:px-20">
                ...
                <div>
                    ...
                    <ActionButton key={1} parentClassName="hover:bg-neutral-900">
...
const ActionButton = ({ children ,parentClassName}: { children: React.ReactNode,parentClassName?:string }) => {
    return <div className={`${parentClassName} border relative group border-px border-neutral-800 rounded-sm flex items-center justify-center py-1`}>
        {children}
