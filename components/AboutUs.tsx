...
export function AboutUs() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 py-20 lg:py-10 px-4 lg:px-20 gap-4  w-full">
      <WobbleCard
        containerClassName="col-span-1 lg:col-span-2  h-full bg-pink-800 min-h-[fit] min-h-[300px]"
        className=""
      >
        ...
        <Image
          ...
          className="absolute hidden md:block -right-4 md:-right-[20%] lg:-right-[30%] grayscale filter md:-bottom-20 lg:-bottom-60 object-contain rounded-2xl"
        />
      </WobbleCard>
      ...
      <WobbleCard containerClassName="col-span-1 lg:col-span-3 bg-blue-900 min-h-[fit] min-h-[300px]">
        ...
        <Image
          ...
          height={500}
          alt="linear demo image"
          className="absolute hidden md:block -right-10 md:-right-[20%] lg:-right-[14%] md:-bottom-30 lg:-bottom-50 object-contain rounded-2xl"
        />
      </WobbleCard>
    </div>
  );
